  ...
  <div class="login-container">
    ...
    >
      ...
      <el-form-item prop="verifyCode">
        ...
        <div class="captcha" v-html="captchaBase64" @click="getCaptcha"></div>
      </el-form-item>
 ...
 * 验证码图片Base64字符串
 */
const captchaBase64 = ref('<svg></svg>');
...
function handleLogin() {
  loginFormRef.value.validate((valid: boolean) => {
    if (valid) {
      //windows 自行判断验证码
      if(loginData.value.verifyCode!=svgText.value){
